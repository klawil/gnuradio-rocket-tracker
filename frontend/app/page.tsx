...
export default function Home() {
  ...
  }, [ isLoading, deviceErr, devices, loadDevices ]);
  ...
  return (
    <Container fluid={true}>
      ...
      {hasDevices && <Row className='justify-content-center mb-3'><Col md={6}>
        <MapContainer
          className={styles.map}
          center={hasGpsDevices
            ? [
      ...
      <Table striped={true} className="text-center">
        ...
        <tbody>
          ...
          {!isLoading && devices !== null && devices.length > 0 && devices.map(device => (<tr key={device.DeviceSerial}>
